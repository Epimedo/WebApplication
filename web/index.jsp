    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <c:if test="${sessionScope.accountStatus=='signedPassenger'}">
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="/Taxi/order?command=Go_To_Order">
                            <c:out value="${order}"/>
                        </a>
                    </li>
                </c:if>
                <c:if test="${sessionScope.accountStatus=='signedDriver'}">
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="/Taxi/driver?command=Go_To_Driver">
                            <c:out value="${driver}"/>
                        </a>
                    </li>
                </c:if>
                <c:if test="${sessionScope.accountStatus=='signedAdmin'}">
                    <li class="nav-item">
