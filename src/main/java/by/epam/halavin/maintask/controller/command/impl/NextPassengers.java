...
public class NextPassengers implements Command {
    public static final Logger log = LogManager.getLogger(NextPassengers.class);
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        UserLibrary driLibrary = factory.getPassLibrary();

        try {
            int start = (int) session.getAttribute(Attributes.CUR_PASS_POSITION.getName()) + COUNT;
            ...
            session.setAttribute(Attributes.PASSENGERS.getName(), driLibrary.getUserIndexOf(start, count));
