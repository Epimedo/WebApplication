...
public class RegisterInPassenger implements Command {
    public static final Logger log = LogManager.getLogger(RegisterInPassenger.class);
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        UserCreator userCreator = utilFactory.getPassCreator();
